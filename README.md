...
I'm a `Machine Learning Enthusiast` and `CyberSecurity Guy` alongside a `Python` Developer.

Check out my [**`featured repos`**](https://github.com/deepraj02?tab=repositories) to know my skills better. Hit a ⭐ if you like it.
...
- 💻 `Photographer` and `Python Developer`, currently studying in **Kendriya Vidyalaya Kailashahar, Kailashahar**.
- ⚡️ **Machine Learning** Enthusiast
- 🤖 Creator of a `Library Management System With MySQL Integration`, [Library Management](https://github.com/deepraj02/LibraryManagement_Database), using **Tkinter and MySQL**.
- 🥇 An **`Open-Source Contributor`** and would love to colab on **Open Source Projects**.
- 🔭 Currently working on mastering skills of `DS,Algo and Data Science` and `Web Developmen`.
- 👨‍💻 I’m also a part-time `Photographer and Video-Editor`.
- 🤔 Favourite **_`hobby`_**:- `Reading Books and Playing Football.
...
- 💡 A New `Project` idea in mind? Create your repo and add me as `Collaborator` with my `Username`: [deepraj02](https://github.com/deepraj02)
  <br>
...
<p>
  <a href="https://github.com/deepraj02/PassWord_Generator-GUI-">
    <img src="https://github-readme-stats.vercel.app/api/pin/?username=deepraj02&repo=PassWord_Generator-GUI-&show_icons=true&theme=radical" />
  </a>
  <a href="https://github.com/deepraj02/QR_Code_Generator-GUI-">
    <img src="https://github-readme-stats.vercel.app/api/pin/?username=deepraj02&repo=QR_Code_Generator-GUI-&show_icons=true&theme=radical" />
  </a>
</p>
